...
const PatientLogin = () => {
  ...
  const loginUser = (data) => {
    console.log(data);
    axios
      .post("http://localhost:8080/patient/login", data)
        ...
        <div className="h-40">
          <div className="g-6 mt-52 flex h-full flex-wrap items-center lg:place-content-evenly">
            ...
            <div>
              ...
              <div className="font-Roboto mb-7 text-4xl font-medium">
                Patient Login
              </div>
              ...
              <form onSubmit={handleSubmit(loginUser)}>
                ...
                <div className="group relative z-0 mb-4 w-60 ">
                  <div>
                    <div>
                      <label
                        htmlFor="password"
                    ...
                    {/* <p class="ml-36 text-xs text-gray-950 dark:text-white">
                      Forget Password?
                    </p> */}
                    {errors.password && (
                      <p
                ...
                <p class="gap-2 text-center text-slate-600">
                ...
                <button
                  type="submit"
                  className=" mt-1 rounded-lg bg-button px-5 py-2.5 text-center text-sm font-medium text-white  hover:bg-primary focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-primary dark:hover:bg-primary dark:focus:ring-primary sm:w-auto lg:w-60"
                >
                  Login
                </button>
              </form>
